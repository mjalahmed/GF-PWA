-- Repair Phase 2 role grants (idempotent).
-- Ensures customer and onboarding_officer receive onboarding permissions
-- even if an earlier environment applied the permission rows without mappings.
