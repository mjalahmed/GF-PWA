...
export function mapCategoryRef(raw: Record<string, unknown>): CategoryRef {
  return {
    ...
    nameAr: (pick(raw, 'nameAr', 'name_ar') as string | null) ?? null,
  }
}
...
export function mapPublicService(raw: Record<string, unknown>): PublicService {
  ...
  return {
    ...
    descriptionAr: (pick(raw, 'descriptionAr', 'description_ar') as string | null) ?? null,
...
export function mapInvoice(raw: Record<string, unknown>): Invoice {
  return {
    ...
    businessId: String(pick(raw, 'businessId', 'business_id') ?? ''),
    businessName: pick(raw, 'businessName', 'business_name') as string | undefined,
    customerName: pick(raw, 'customerName', 'customer_name') as string | undefined,
    customerPhone: pick(raw, 'customerPhone', 'customer_phone') as string | undefined,
    vehicleMake: pick(raw, 'vehicleMake', 'vehicle_make') as string | undefined,
    vehicleModel: pick(raw, 'vehicleModel', 'vehicle_model') as string | undefined,
    vehicleYear: pickNum(raw, 'vehicleYear', 'vehicle_year'),
    vehicleLabel: pick(raw, 'vehicleLabel', 'vehicle_label') as string | undefined,
    vehicleImagePath: pick(raw, 'vehicleImagePath', 'vehicle_image_path') as string | undefined,
